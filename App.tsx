          ...
          <main className="flex-1 min-w-0 pt-12 px-4 md:px-12 max-w-5xl mx-auto border-l border-r border-gray-50/50 min-h-screen">
            ...
            <header className="mb-16 pl-0 md:pl-[3.25rem]">
              ...
              <p className="text-lg text-gray-400 font-serif italic">
                ...
                {selectedEmoji && (
                  <span className="not-italic ml-2 text-black bg-gray-100 px-3 py-1 rounded-full text-xs font-heading font-bold uppercase tracking-widest inline-flex items-center gap-2 cursor-pointer hover:bg-gray-200 transition-colors" onClick={() => handleTopicSelect(null)}>
